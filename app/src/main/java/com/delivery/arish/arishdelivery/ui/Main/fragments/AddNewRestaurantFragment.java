...
public class AddNewRestaurantFragment extends Fragment implements View.OnClickListener {
    // --Commented out by Inspection (14/11/18 01:04 م):private static final String TAG = AddNewRestaurantFragment.class.getSimpleName();

    @SuppressWarnings("WeakerAccess")
    @BindView(R.id.img_show_add_rest)
    protected ImageView mImgSowAddNew;
    @SuppressWarnings("WeakerAccess")
    @BindView(R.id.rv_show_rest)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.add_new_restaurant_fragment, container, false);
        ButterKnife.bind(this, rootView);
        MainPresenter mMainPresenter = new MainPresenter(getActivity());
        mMainPresenter.getRestaurantArrayList(mRvShowAll, getLayoutInflater());
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.img_show_add_rest:
                Intent intent = new Intent(getActivity(), EitDataActivity.class);
                Bundle extras = new Bundle();
                extras.putInt(Contract.EXTRA_FRAGMENT_POSITION, 1);
